                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                      <td colspan="2"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                              ...
                              <td style="color:#666666;font-family:Arial,Helvetica,sans-serif;font-size:1em;line-height:14px" align="right" valign="middle">Rs {{$transaction->amount}}</td>
                              <td width="10"></td>
                            </tr>
                            <tr>
                              ...
                              <td style="color:#666666;font-family:Arial,Helvetica,sans-serif;font-size:1em;line-height:14px" align="right" valign="middle">@if($bill)Rs {{ $bill->discount }}@else 0 @endif</td>
                              <td width="10"></td>
                            </tr>
                            <tr>
                              <td colspan="4" bgcolor="#e6e6e6" height="1"></td>
