              ...
              <td><div>
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
					  ...
					  <td></td>
                    <tr>
                      <td colspan="2" style="color:#666666;font-size:1em;line-height:22px;font-family:Arial,Helvetica,sans-serif">Dear <span class="il">{{ $customer->first_name }},</span></a></td>
                    </tr>
                    <tr>
                      <td height="16"></td>
                    </tr>
                    ...
                    <tr>
                      <td colspan="2"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                          ...
                          <tr>
                            <td style="color:#666666;font-size:1em;line-height:22px;font-family:Arial,Helvetica,sans-serif" height="31" valign="middle">Account ID: <strong style="color:#000000;font-weight:normal"> {{ $bill->account_id }}</strong></td>
                          ...
                          <tr>
                            <td style="color:#666666;font-size:1em;line-height:22px;font-family:Arial,Helvetica,sans-serif" height="31" valign="middle">Payment :<strong style="color:#000000;font-weight:normal">Off line </strong></td>
                          </tr>
                    ...
                    <tr>
                      <td colspan="2"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                          ...
                          <tr>
                            ...
                            <td style="color:#000000;font-family:Arial,Helvetica,sans-serif;font-size:1em;font-weight:bold;line-height:14px" align="right" valign="middle">Rs {{$bill->amount_paid}} /-</td>
                            <td width="10"></td>
                          </tr>
                          <tr>
                            <td height="36" width="10"></td>
