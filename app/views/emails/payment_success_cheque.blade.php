  ...
  <td width="80%"><table align="center" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="580">
      ...
      <tr>
        ...
        <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <td></td>
                    <tr>
                      <td colspan="2" style="color:#666666;font-size:1em;line-height:22px;font-family:Arial,Helvetica,sans-serif">Dear <span class="il">{{ $user->first_name }}</span></a></td>
                    </tr>
                    <tr>
                      <td height="16"></td>
                    </tr>
                    <tr>
                      <td colspan="2" style="color:#666666;font-size:1em;line-height:22px;font-family:Arial,Helvetica,sans-serif">Thank you for paying your OODOO Fiber Bill. Your Payment has been successfully processed</td>
                    </tr>
                                        <tr>
                    ...
                    <tr>
                      <td colspan="2"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                          ...
                          <tr>
                            ...
                            <td style="color:#666666;font-size:1em;line-height:22px;font-family:Arial,Helvetica,sans-serif" width="107">Order Amount:</td>
                    ...
                    <tr>
                      <td colspan="2"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                              ...
                              <td style="color:#666666;font-family:Arial,Helvetica,sans-serif;font-size:1em;line-height:14px" align="right" valign="middle">Rs {{$bill->amount_before_due_date}}</td>
                              <td width="10"></td>
                            </tr>
                            <tr>
                    ...
                    <tr>
                                        <td colspan="2" style="color:#000000;font-family:Arial,Helvetica,sans-serif;font-weight:bold;font-size:13px">Cheque Details</td>
                                      </tr>
                                      <tr>
                    ...
                    <tr>
                      <td colspan="2"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                          <tbody><tr>
                            <td colspan="2"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tbody><tr>
                                  <td colspan="5" bgcolor="#f2f2f2" height="1"></td>
                                  <td></td>
                                  <td colspan="5" bgcolor="#f2f2f2" height="1"></td>
                                </tr>
                                <tr>
                                  ...
                                  <td width="4%"></td>
                                  <td valign="top" width=""><table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                      ...
                                      <tr>
                                        <td style="color:#000000;font-size:13px;line-height:15px;font-weight:bold;font-family:Arial,Helvetica,sans-serif" align="left">Cheque No:<a
                                         style="color:#666666;font-size:13px;line-height:15px;font-family:Arial,Helvetica,sans-serif" align="left"> $cheque_no<br></a></td>
                                      </tr>
                                      <tr>
                                        <td colspan="2" height="10"></td>
                     ...
                     <tr>
                                      <tr>
                                      <tr>
                                        <td style="color:#000000;font-size:13px;line-height:15px;font-weight:bold;font-family:Arial,Helvetica,sans-serif" align="left">Bank Details:<a
                                         style="color:#666666;font-size:13px;line-height:15px;font-family:Arial,Helvetica,sans-serif" align="left"> $Bank_Details<br></a></td>
                                      </tr>
                                        <td colspan="2" height="10"></td>
                     ...
                     <tr>
                      ...
                      <td colspan="2" height="23"></td>
                                         ...
                                         <tr>
                      <td style="color:#666666;font-family:Arial,Helvetica,sans-serif;font-size:1em;line-height:20px" colspan="2">Your Account will be credited with the amount paid within 24 Hours subjected to clearance of the cheque provided. To view details of the payment,</td>
                    </tr>
